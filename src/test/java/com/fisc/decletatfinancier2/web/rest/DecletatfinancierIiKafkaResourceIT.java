...
import com.fisc.decletatfinancier2.DecletatfinancierIiApp;
...
@SpringBootTest(classes = DecletatfinancierIiApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DecletatfinancierIiKafkaResourceIT {
    ...
    @Autowired
    private DecletatfinancierIiKafkaProducer producer;

    @Autowired
    private DecletatfinancierIiKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DecletatfinancierIiKafkaResource kafkaResource = new DecletatfinancierIiKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/decletatfinancier-ii-kafka/publish?message=test"))
